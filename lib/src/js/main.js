const main = () => {
    ...
    function isLoaded() {
        var playerLoaded = Object.keys(player.assets).reduce(function(prev, assetName) {
            var asset = player.assets[assetName]
            return prev && asset.loaded
        }, true)

        return playerLoaded && world.assets.background.loaded
    }
    ...
    function loadAssets() {
        ...
        world.assets.background.sprite.src = 'http://localhost:3000/images/background0.png'
        world.assets.background.sprite.onload = function() { world.assets.background.loaded = true }
    }
